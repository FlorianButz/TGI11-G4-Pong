...
public class BossAttackPlus extends GameObject {
	...
	BossAttackPlus getObj() {
		return this;
	}

	Rectangle2D plus1 = new Rectangle2D.Float(0 - 2000, 0 - 50 + 250, 4000, 100);
	Rectangle2D plus2 = new Rectangle2D.Float(0 - 2000, 0 - 50 - 250, 4000, 100);
	...
	public void update() {
		...
		plus1 = new Rectangle2D.Float(0 - 2000, 0 - 50 + 250, 4000, 100);
		plus2 = new Rectangle2D.Float(0 - 2000, 0 - 50 - 250, 4000, 100);
