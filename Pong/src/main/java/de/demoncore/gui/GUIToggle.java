...
public class GUIToggle extends GUIObject {
	...
	public void Draw(Graphics2D g2d, int screenWidth, int screenHeight) {
		...
		if(this.isHovering) {
			...
			currentCheckmarkColor = GameMath.LerpColor(currentCheckmarkColor, hoverCheckmarkColor, colorTransitionSmoothing / fps);
			...
			currentCheckmarkColor = GameMath.LerpColor(currentCheckmarkColor, normalCheckmarkColor, colorTransitionSmoothing / fps);
