...
public class GUIParticleSystem extends GUIObject {
	...
	public GUIParticleSystem(int x, int y) {
		super(x, y, 5, 5);
	...
	void AddParticle() {
		...
		p.position = p.position.add(randomSpawnPosition).add(this.getUIPosition(sw, sh));
